...
class ATMControllerAdapterTest {
  ...
  static final String API_WINDOW_URL_ACCOUNTS_ENDPOINT = "/api/window/accounts/";
  static final String API_ATM_URL_ACCOUNTS_ENDPOINT = "/api/atm/accounts/";
  ...
  void retrieveAccountTest() throws Exception {
    ...
    mockMvc.perform(
            MockMvcRequestBuilders.get(API_ATM_URL_ACCOUNTS_ENDPOINT + id)
  ...
  void retrieveNonExistingAccountTest() throws Exception {
    // Retrieve
    mockMvc.perform(
            MockMvcRequestBuilders.get(API_ATM_URL_ACCOUNTS_ENDPOINT + "INV_ID")
                .contentType(MediaType.APPLICATION_JSON))
  ...
  void depositDifferentCurrencyAmountTest() throws Exception {
    ...
    mockMvc.perform(
            MockMvcRequestBuilders.get(
                    API_ATM_URL_ACCOUNTS_ENDPOINT + id + Constants.URL_DELIMITER
                        + DEPOSIT_OPERATION)
  ...
  private String createAccount() throws Exception {
    // Create
    MvcResult result = mockMvc.perform(MockMvcRequestBuilders.get(API_WINDOW_URL_ACCOUNTS_ENDPOINT)
            .param("name", USERNAME)
            .param("currency", EUR))
        .andExpect(MockMvcResultMatchers.status().isOk())
        .andReturn();
